...
const DOMAINS: DomainDef[] = [
  {
    ...
    suggest: (i, has, done) => has('id_documents') ? 'not_ready' : done('legal') ? 'ready' : 'na',
  },
  {
    ...
    suggest: (i, has, done) => has('housing') ? 'not_ready' : done('housing') ? 'ready' : 'na',
  },
  {
    ...
    suggest: (i, has, done) => has('transportation') ? 'not_ready' : done('transit') ? 'ready' : 'na',
  },
  {
  ...
  },
  {
    ...
    suggest: (i, has) => {
      ...
      return i.supervision === 'none' ? 'ready' : 'na';
    },
  },
  {
    ...
    suggest: (i) => {
      if (!i.education || i.education === 'unknown') return 'na';
  ...
  },
  {
    ...
    suggest: (i) => {
      if (!i.careerGoal && (i.certifications?.length ?? 0) === 0) return 'na';
      if (!i.careerGoal) return 'in_progress';
  ...
  },
  {
    ...
    suggest: (i, has, done) => has('food') ? 'not_ready' : done('food') ? 'ready' : 'na',
  },
  {
