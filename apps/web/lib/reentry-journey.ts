...
export const PHASES: JourneyPhase[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: route('Get ID help', '/local-help?tab=community'),
        urgent: true,
      },
      {
        id: 'housing',
      ...
      },
      {
        ...
        action: route('Find transportation help', '/local-help?tab=community'),
      },
      {
        id: 'supervision',
        ...
        action: route('Set up reminders', '/local-help?tab=checklist'),
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        action: route('Find a reentry program', '/local-help?tab=reentry'),
      },
      {
        id: 'talk',
    ...
    steps: [
      {
        ...
        action: route('Track your plan', '/local-help?tab=checklist'),
      },
      {
        id: 'readiness',
        ...
        action: route('Open My Plan', '/local-help?tab=checklist'),
      },
      {
        id: 'learn',
